import { createStudy, deleteStudy, listStudies, normalizeStudy, updateStudy } from "@/lib/studies-store";
...
export async function GET() {
  return Response.json({ studies: listStudies() }, { headers: { "cache-control": "no-store" } });
}
...
export async function POST(request: Request) {
  ...
  try {
    ...
    return Response.json({ study: createStudy(input) }, { status: 201 });
  } catch {
...
export async function PUT(request: Request) {
  ...
  try {
    ...
    return Response.json({ study: updateStudy(id, input) });
  } catch {
...
export async function DELETE(request: Request) {
  ...
  try {
    ...
    return Response.json({ deleted: deleteStudy(id) });
  } catch {
